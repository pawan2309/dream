        ...
        <div className="row mb-2">
          ...
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item"><Link href="/user_details/agent">Agent</Link></li>
              <li className="breadcrumb-item active">Update Agent Limit</li>
            </ol>
          </div>
        </div>
        <div className="row">
            ...
            <div className="card card-indigo">
              ...
              <div className="card-body">
                ...
                <div className="row mt-3">
                  <div className="col-sm-6">
                    <p>Showing {filteredAgents.length === 0 ? 0 : startIndex + 1} to {Math.min(endIndex, filteredAgents.length)} of {filteredAgents.length} entries</p>
                </div>
                  <div className="col-sm-6 text-right">
                    <nav>
...
export default AgentLimitUpdatePage; 