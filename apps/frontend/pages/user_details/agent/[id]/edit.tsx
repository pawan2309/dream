  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push('/user_details/agent');
  ...
  return (
    <Layout>
      <form onSubmit={handleSubmit}>
            ...
            <div className="card card-secondary">
              ...
              <div className="card-body">
                <div className="form-group row mb-0">
                  <div className="form-group col-md-4"><label>Agent Share</label><input type="number" name="share" className="form-control" value={form.share} onChange={handleChange} placeholder="Share" /></div>
                ...
                <div className="form-group row mb-0">
                  <div className="form-group col-md-4"><label>Agent Casino Share</label><input type="number" name="casinoShare" className="form-control" value={form.casinoShare} onChange={handleChange} placeholder="Casino Share" /></div>
        ...
        <div className="row mx-0 "><div className="col-12 subowner-cancel-create mb-4 px-0"><button type="button" className="btn btn-secondary" onClick={() => router.push('/user_details/agent')}>Cancel</button><button type="submit" className="btn btn-success float-right">Update agent</button></div></div>
