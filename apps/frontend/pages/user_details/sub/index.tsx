                ...
                <form action="#" method="post" id="demoForm">
                  <div className="card-header">
                    <div className="form-group">
                      <Link href="/user_details/sub/create" className="btn btn-primary mr-2">
                        New <i className="fa fa-plus-circle"></i>
                      </Link>
                      <Link href="/user_details/sub/limit" className="btn btn-info mr-2">
                                ...
                                <div className="dropdown">
                                  ...
                                  {openDropdown === user.id && (
                                    <div className="dropdown-menu show" style={{ position: 'absolute', zIndex: 1000 }}>
                                      ...
                                      <button className="dropdown-item" onClick={(e) => handleDropdownAction('changePassword', user, e)}>Change Password</button>
                                      <button className="dropdown-item" onClick={(e) => handleDropdownAction('downline', user, e)}>Downline</button>
                                      <button className="dropdown-item" onClick={() => alert('Send Login Details (SMS)')} disabled={!user.contactno}>Send Login Details (SMS)</button>
                                      <button className="dropdown-item" onClick={() => alert('Send Login Details (Device)')} disabled={!user.contactno}>Send Login Details (Device)</button>
                                    </div>
                                  )}
                                </div>
                              </td>
