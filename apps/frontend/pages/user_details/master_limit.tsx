...
export default function MasterLimitUpdate() {
  ...
  const handleLimitUpdate = async (userId: string, amount: number, type: 'Add' | 'Minus') => {
    ...
    try {
      ...
      if (response.ok) {
        // Show success message (TODO: Replace with proper toast notification)
        fetchUsers(); // Refresh the list
      } else {
        const error = await response.json();
        // Show error message (TODO: Replace with proper toast notification)
      }
    } catch (error) {
          ...
          <div className="col-12">
            <div className="card card-indigo">
              <div className="card-header">
                ...
                <a href="/user_details/master" className="btn btn-secondary">
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                if (amount > 0) {
                                  ...
                                  // Show validation message (TODO: Replace with proper toast notification)
                                }
                              }}
