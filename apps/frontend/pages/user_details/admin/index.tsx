                ...
                <form action="#" method="post" id="demoForm">
                  <div className="card-header">
                    <div className="form-group">
                      <Link href="/user_details/admin/create" className="btn btn-primary mr-2">
                        New <i className="fa fa-plus-circle"></i>
                      </Link>
                      <Link href="/user_details/admin/limit" className="btn btn-info mr-2">
                        Limit Update <i className="fa fa-coins"></i>
                      </Link>
                      {/* Remove the badge showing selectedUsers.length */}
