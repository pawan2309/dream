...
const AdminLimitUpdatePage = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Update Admin Limit</title>
          ...
          <div className="row mb-2">
            ...
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                <li className="breadcrumb-item"><Link href="/user_details/admin">Admin</Link></li>
                <li className="breadcrumb-item active">Update Admin Limit</li>
              </ol>
            </div>
          </div>
        </div>
...
export default AdminLimitUpdatePage; 