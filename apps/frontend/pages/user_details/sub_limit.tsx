...
export default function SubLimitUpdate() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('/api/users?role=SUB');
      if (response.ok) {
          ...
          <div className="col-12">
            <div className="card card-indigo">
              <div className="card-header">
                ...
                <a href="/user_details/sub" className="btn btn-secondary">
                  <i className="fa fa-arrow-left"></i> Back to Sub Agents
                </a>
              </div>
