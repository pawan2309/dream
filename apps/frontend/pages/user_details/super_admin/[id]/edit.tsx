  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push('/user_details/super_admin');
  ...
  return (
    <Layout>
      <form onSubmit={handleSubmit}>
            ...
            <div className="card card-secondary">
              ...
              <div className="card-body">
                <div className="form-group row mb-0">
                  <div className="form-group col-md-4"><label>Superadmin Share</label><input type="number" name="share" className="form-control" value={form.share} onChange={handleChange} placeholder="Share" /></div>
                  <div className="form-group col-md-4"><label>Subowner Share On Superadmin</label><input className="form-control" name="subownerShare" type="text" value={form.subownerShare} readOnly /></div>
                  <div className="form-group col-md-4"><label>My Share</label><input type="number" className="form-control" name="myShare" value={form.myShare} readOnly /></div>
                </div>
                ...
                <div className="form-group row mb-0">
                  <div className="form-group col-md-4"><label>Superadmin Casino Share</label><input type="number" name="casinoShare" className="form-control" value={form.casinoShare} onChange={handleChange} placeholder="Casino Share" /></div>
                  <div className="form-group col-md-4"><label>Subowner Casino Share On Superadmin</label><input className="form-control" name="subownerCasinoShare" type="text" value={form.subownerCasinoShare} readOnly /></div>
                  <div className="form-group col-md-4"><label>My Casino Share</label><input type="number" className="form-control" name="myCasinoShare" value={form.myCasinoShare} readOnly /></div>
                </div>
                <div className="form-group row mb-0">
        ...
        <div className="row mx-0 "><div className="col-12 subowner-cancel-create mb-4 px-0"><button type="button" className="btn btn-secondary" onClick={() => router.push('/user_details/super_admin')}>Cancel</button><button type="submit" className="btn btn-success float-right">Update superadmin</button></div></div>
