...
const mockSupers = [
  { id: 'S1001', name: 'S1001 Super1' },
  { id: 'S1002', name: 'S1002 Super2' },
  { id: 'S1003', name: 'S1003 Super3' },
];
                    ...
                    <div className="card-header ">
                      ...
                      <div className="form-row col-md-9">
                        <div className="form-group col-md-4">
                          <label htmlFor="name" className="text-capitalize">Super</label>
                          <select className="form-control" required id="name" name="super" value={form.super} onChange={handleChange}>
