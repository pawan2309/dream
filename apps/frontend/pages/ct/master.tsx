...
const mockMasters = [
  { id: 'M1001', name: 'M1001 Master1' },
  { id: 'M1002', name: 'M1002 Master2' },
  { id: 'M1003', name: 'M1003 Master3' },
];
                    ...
                    <div className="card-header ">
                      ...
                      <div className="form-row col-md-9">
                        <div className="form-group col-md-4">
                          <label htmlFor="name" className="text-capitalize">Master</label>
                          <select className="form-control" required id="name" name="master" value={form.master} onChange={handleChange}>
