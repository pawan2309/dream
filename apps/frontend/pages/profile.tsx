                  ...
                  <div className="card-body box-profile">
                    ...
                    <ul className="list-group list-group-unbordered mb-3">
                      <li className="list-group-item">
                        <b>Share</b> <a className="float-right">{user.share || 0}%</a>
                      </li>
                      <li className="list-group-item">
                        <b>Match Commission</b> <a className="float-right">{user.matchcommission || 0}%</a>
                      </li>
                      <li className="list-group-item">
                        <b>Session Commission</b> <a className="float-right">{user.sessioncommission || 0}%</a>
                      </li>
                      <li className="list-group-item">
              ...
              <div className="col-lg-4">
                <div className="card card-info">
                  ...
                  <div className="card-body">
                    ...
                    <p className="text-muted">{user.session_commission_type || 'No Comm'}</p>

                    <hr />

                    <strong><i className="fas fa-percentage"></i> Casino Commission</strong>
                    <p className="text-muted">{user.casinocommission || 0}%</p>

                    <hr />

                    <strong><i className="fas fa-share-alt"></i> Casino Share</strong>
                    <p className="text-muted">{user.cshare || 0}%</p>

                    <hr />

                    <strong><i className="fas fa-gamepad"></i> Int. Casino Share</strong>
                    <p className="text-muted">{user.icshare || 0}%</p>
                  </div>
                </div>
              </div>
            </div>
